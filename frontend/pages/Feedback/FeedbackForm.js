...
export default function FeedbackForm() {
  ...
  return (
    <div className="container col-lg-6 my-5 ">
      ...
      <form onSubmit={handleSubmit} className="card p-4 shadow text-start bg-dark text-light">
        <div className="row">
        ...
        <div className="text-center">
          <button type="submit" className="btn btn-dark px-4" style={{backgroundColor:'#595959'}}>
            Submit
          </button>
        </div>
      </form>
