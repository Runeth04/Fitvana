...
export default function UpdateTrainer() {
  ...
  const fetchTrainerData = async () => {
    try {
      const res = await fetch(`http://localhost:8070/trainer/${trainerId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(errorData.error || "Failed to update trainer");
      }
    } catch (error) {
  ...
  // Render form same as AddTrainer (reusing your form layout)
  return (
    <div className="d-flex justify-content-center align-items-center bg-dark text-light min-vh-100">
      <div className="card bg-secondary text-light p-4 col-lg-8 shadow-lg rounded-4">
        <h3 className="text-center mb-4">Update Trainer</h3>
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="mb-3 text-start">
            ...
            {/* Show thumbnail preview if image is available */}
                  ...
                  <img
                    src={
                      profileImage
                        ...
                        : `http://localhost:8070/uploads/${formData.profileImage}`
                    }
                    alt="Profile Preview"
