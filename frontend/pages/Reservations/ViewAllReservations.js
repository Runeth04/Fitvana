...
export default function ViewAllReservations() {
  ...
  const filteredData = reservationData.filter((data) => {
    ...
    const phone = data.trainerId.specialization ? data.trainerId.specialization.toLowerCase() : "";          //search query
  ...
  return (
    <>
      <div className="container justify-content-start mt-5 bg-light">
        <h1 className="text-center text-dark">All Reservations</h1>
